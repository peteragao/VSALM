...
#include "stanExports_iid_joint_smooth.h"

RCPP_MODULE(stan_fit4iid_joint_smooth_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_iid_joint_smooth")
