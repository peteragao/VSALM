...
namespace model_iid_joint_smooth_logit_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(101, 99, "end", "model_iid_joint_smooth_logit");
    return reader;
}
...
class model_iid_joint_smooth_logit
  : public stan::model::model_base_crtp<model_iid_joint_smooth_logit> {
private:
        int N;
        int N_data;
        int K;
...
public:
    model_iid_joint_smooth_logit(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_iid_joint_smooth_logit_namespace::model_iid_joint_smooth_logit";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_iid_joint_smooth_logit_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_iid_joint_smooth_logit";
    }
...
typedef model_iid_joint_smooth_logit_namespace::model_iid_joint_smooth_logit stan_model;
#ifndef USING_R
