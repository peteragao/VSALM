...
namespace model_iid_joint_smooth_unmatched_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_iid_joint_smooth_unmatched");
    reader.add_event(105, 103, "end", "model_iid_joint_smooth_unmatched");
    return reader;
}
...
class model_iid_joint_smooth_unmatched
  : public stan::model::model_base_crtp<model_iid_joint_smooth_unmatched> {
private:
        int N;
        int N_data;
        int K;
        ...
        double pc_tau_alpha;
public:
    model_iid_joint_smooth_unmatched(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_iid_joint_smooth_unmatched_namespace::model_iid_joint_smooth_unmatched";
    ...
    ~model_iid_joint_smooth_unmatched() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(theta_obs, inv_logit(theta_obs));
            current_statement_begin__ = 67;
            for (int i = 1; i <= N_data; ++i) {
                current_statement_begin__ = 68;
                stan::model::assign(sigma_e, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            stan::math::sqrt(stan::math::exp((((g0 + (g1 * stan::math::log((get_base1(theta_obs, get_base1(ind_data, i, "ind_data", 1), "theta_obs", 1) * (1 - get_base1(theta_obs, get_base1(ind_data, i, "ind_data", 1), "theta_obs", 1)))))) + (g2 * stan::math::log(get_base1(na, i, "na", 1)))) + (sigma_tau * get_base1(tau, i, "tau", 1))))), 
            ...
            for (int i = 1; i <= N_data; ++i) {
                ...
                lp_accum__.add(normal_log(get_base1(Yhat, i, "Yhat", 1), get_base1(theta_obs, theta_k, "theta_obs", 1), get_base1(sigma_e, i, "sigma_e", 1)));
            }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_iid_joint_smooth_unmatched_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(theta, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            inv_logit(normal_rng(logit(get_base1(theta_obs, i, "theta_obs", 1)), sigma_u, base_rng__)), 
    ...
    std::string model_name() const {
        return "model_iid_joint_smooth_unmatched";
    }
...
typedef model_iid_joint_smooth_unmatched_namespace::model_iid_joint_smooth_unmatched stan_model;
#ifndef USING_R
