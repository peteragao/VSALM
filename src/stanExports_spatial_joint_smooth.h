...
namespace model_spatial_joint_smooth_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_spatial_joint_smooth");
    reader.add_event(104, 102, "end", "model_spatial_joint_smooth");
    return reader;
}
...
class model_spatial_joint_smooth
  : public stan::model::model_base_crtp<model_spatial_joint_smooth> {
private:
        int N;
        int N_data;
        int N_edges;
...
public:
    model_spatial_joint_smooth(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_spatial_joint_smooth_namespace::model_spatial_joint_smooth";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_spatial_joint_smooth_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_spatial_joint_smooth";
    }
...
typedef model_spatial_joint_smooth_namespace::model_spatial_joint_smooth stan_model;
#ifndef USING_R
