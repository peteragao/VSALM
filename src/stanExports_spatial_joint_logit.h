...
namespace model_spatial_joint_logit_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_spatial_joint_logit");
    reader.add_event(100, 98, "end", "model_spatial_joint_logit");
    return reader;
}
...
class model_spatial_joint_logit
  : public stan::model::model_base_crtp<model_spatial_joint_logit> {
private:
        int N;
        int N_data;
        int N_edges;
...
public:
    model_spatial_joint_logit(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_spatial_joint_logit_namespace::model_spatial_joint_logit";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            local_scalar_t__ prec_c;
            (void) prec_c;  // dummy to suppress unused var warning
            stan::math::initialize(prec_c, DUMMY_VAR__);
            stan::math::fill(prec_c, DUMMY_VAR__);
            ...
            stan::math::assign(prec_c, (1 / pow(sigma_u, 2)));
            ...
            for (int i = 1; i <= N_data; ++i) {
                ...
                stan::model::assign(sigma_e, 
                            ...
                            stan::math::sqrt(stan::math::exp((((g0 + (g1 * stan::math::log((inv_logit(get_base1(theta, get_base1(ind_data, i, "ind_data", 1), "theta", 1)) * (1 - inv_logit(get_base1(theta, get_base1(ind_data, i, "ind_data", 1), "theta", 1))))))) + (g2 * stan::math::log(get_base1(df, i, "df", 1)))) + (sigma_tau * get_base1(tau, i, "tau", 1))))), 
                ...
                stan::model::assign(ss_cl, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (((get_base1(df, i, "df", 1) - 1) * get_base1(Vhat, i, "Vhat", 1)) / get_base1(V, i, "V", 1)), 
            ...
            current_statement_begin__ = 58;
            if (stan::math::is_uninitialized(prec_c)) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: prec_c";
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable prec_c: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            check_greater_or_equal(function__, "prec_c", prec_c, 0);
            // model body
            {
            ...
            lp_accum__.add(pcprec_lpdf(prec_c, 1, .01, pstream__));
            current_statement_begin__ = 89;
            lp_accum__.add(pcprec_lpdf((1 / pow(sigma_tau, 2)), .1, .01, pstream__));
            ...
            for (int i = 1; i <= N_data; ++i) {
                ...
                lp_accum__.add(chi_square_log(get_base1(ss_cl, i, "ss_cl", 1), (get_base1(df, i, "df", 1) - 1)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_spatial_joint_logit_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_spatial_joint_logit";
    }
...
typedef model_spatial_joint_logit_namespace::model_spatial_joint_logit stan_model;
#ifndef USING_R
