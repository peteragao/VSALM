...
#include "stanExports_spatial_joint_smooth_unmatched.h"

RCPP_MODULE(stan_fit4spatial_joint_smooth_unmatched_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_spatial_joint_smooth_unmatched")
