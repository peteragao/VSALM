...
#include "stanExports_spatial_mean_smooth.h"

RCPP_MODULE(stan_fit4spatial_mean_smooth_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_spatial_mean_smooth")
