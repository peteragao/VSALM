...
namespace model_spatial_joint_smooth_logit_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_spatial_joint_smooth_logit");
    reader.add_event(108, 106, "end", "model_spatial_joint_smooth_logit");
    return reader;
}
...
class model_spatial_joint_smooth_logit
  : public stan::model::model_base_crtp<model_spatial_joint_smooth_logit> {
private:
        int N;
        int N_data;
        int N_edges;
...
public:
    model_spatial_joint_smooth_logit(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_spatial_joint_smooth_logit_namespace::model_spatial_joint_smooth_logit";
    ...
    ~model_spatial_joint_smooth_logit() { }
        ...
        try {
            ...
            for (int i = 1; i <= N_data; ++i) {
                ...
                stan::model::assign(sigma_e, 
                            ...
                            stan::math::sqrt(stan::math::exp((((g0 + (g1 * stan::math::log((inv_logit(get_base1(theta, get_base1(ind_data, i, "ind_data", 1), "theta", 1)) * (1 - inv_logit(get_base1(theta, get_base1(ind_data, i, "ind_data", 1), "theta", 1))))))) + (g2 * stan::math::log(get_base1(na, i, "na", 1)))) + (sigma_tau * get_base1(tau, i, "tau", 1))))), 
            ...
            for (int i = 1; i <= N_data; ++i) {
                ...
                lp_accum__.add(normal_log(get_base1(logit_y, i, "logit_y", 1), get_base1(theta, theta_k, "theta", 1), get_base1(sigma_e, i, "sigma_e", 1)));
            }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_spatial_joint_smooth_logit_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_spatial_joint_smooth_logit";
    }
...
typedef model_spatial_joint_smooth_logit_namespace::model_spatial_joint_smooth_logit stan_model;
#ifndef USING_R
