...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(103, 101, "end", "model_spatial_joint_smooth_unmatched");
    return reader;
}
        ...
        try {
            ...
            for (int i = 1; i <= N_data; ++i) {
                ...
                stan::model::assign(sigma_e, 
                            ...
                            stan::math::sqrt(stan::math::exp((((g0 + (g1 * stan::math::log((get_base1(theta, get_base1(ind_data, i, "ind_data", 1), "theta", 1) * (1 - get_base1(theta, get_base1(ind_data, i, "ind_data", 1), "theta", 1)))))) + (g2 * stan::math::log(get_base1(df, i, "df", 1)))) + (sigma_tau * get_base1(tau, i, "tau", 1))))), 
